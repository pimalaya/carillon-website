...
- **The pricing** follows `CARILLON_PLAN.md` §9: free client + self-host, pay only
  for the standing watch via prepaid "notifier-month" credits. Numbers are
  indicative placeholders for the private beta.
