...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      'A watch is one folder or one address book that Carillon keeps an eye on: the INBOX of your work mailbox, for example. Each watch is one standing connection we hold for you. You pay per watch by the month in prepaid credits, and your first watch on a provider runs free for a 7-day trial.',
  },
  {
