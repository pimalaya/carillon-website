...
The site is discoverable by classic search engines, social preview bots, and AI
crawlers alike. Because those bots largely do not run JavaScript, the page is
pre-rendered to static HTML at build time; the standard crawl, social, and
structured-data surface is provided in the `<head>` and as static files in `public/`.
